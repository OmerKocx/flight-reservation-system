...
public record CustomerRequestDto(
        ...
        @NotNull(message = "Email cannot be null") @Email(message = "Email must be valid") @Size(min = 5, max = 50, message = "Email must be between 5 and 100 characters long") String email,
        @NotNull(message = "Phone cannot be null") @Size(min = 11, max = 11, message = "Phone must be 11 characters long") String phone,
        @NotNull(message = "Address cannot be null") @Size(min = 10, max = 255, message = "Address must be between 2 and 255 characters long") String address) {
